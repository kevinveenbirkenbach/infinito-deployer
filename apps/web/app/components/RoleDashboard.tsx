            ...
            <div className={styles.controlsRow}>
              ...
              <div className={styles.controlsRight}>
                <details className={styles.dropdown}>
                  <summary className={styles.dropdownSummary}>View</summary>
                  <div className={`${styles.dropdownCard} ${styles.viewDropdownCard}`}>
                ...
                <details className={styles.dropdown}>
                  <summary className={styles.dropdownSummary}>Filters</summary>
                  <div className={`${styles.dropdownCard} ${styles.filterDropdownCard}`}>
